...
public abstract class ShaderProgram
{
    ...
    {
        vertexShaderID = loadShader(vert, GL20.GL_VERTEX_SHADER) ;
        fragmentShaderID = loadShader(frag, GL20.GL_FRAGMENT_SHADER) ;
    ...
    private static int loadShader( String file, int type )
    {
        ...
        try
        {
            BufferedReader reader = new BufferedReader( new FileReader(GameHelper.files.getFile(file))) ;
            String line ;
